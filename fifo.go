...
func NewFifo(size uint16) *Fifo {
	fifo := &Fifo{buffer: make([]byte, size), writePos: 0, readPos: 0, altReadPos: 0, started: false, aux: 0}
	return fifo
}
...
// Alternate begin, don't exactly know what it doees
